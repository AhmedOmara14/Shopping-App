package com.example.shopping.Recommended;
...
public class adapterforrecommended extends RecyclerView.Adapter<adapterforrecommended.myviewholder> {
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new adapterforrecommended.myviewholder(LayoutInflater.from(context).inflate(R.layout.recommended_rec,parent,false));
    }
